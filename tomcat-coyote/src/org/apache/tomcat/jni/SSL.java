...
public final class SSL
{
    ...
    public static final int SSL_PROTOCOL_ALL = 6;
    ...
    public static native int initialize(final String p0);
    
    public static native int fipsModeSet(final int p0);
    
    public static native boolean randLoad(final String p0);
    
    public static native boolean randSave(final String p0);
    
    public static native boolean randMake(final String p0, final int p1, final boolean p2);
    
    public static native void randSet(final String p0);
    
    public static native long newBIO(final long p0, final BIOCallback p1) throws Exception;
    
    public static native int closeBIO(final long p0);
    
    public static native void setPasswordCallback(final PasswordCallback p0);
    
    public static native void setPassword(final String p0);
    
    public static native boolean generateRSATempKey(final int p0);
    
    public static native boolean loadDSATempKey(final int p0, final String p1);
